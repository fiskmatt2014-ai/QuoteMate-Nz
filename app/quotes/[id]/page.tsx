  ...
  if (!quote) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Navigation />
        <div className="flex items-center justify-center h-screen">
          <div className="text-gray-600">Quote not found</div>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <div className="border-b pb-6 mb-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-lg text-gray-600 mt-1">{quote.quote_number}</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-900">{formatDate(quote.date)}</p>
              {quote.valid_until && (
                <>
                  <h3 className="text-sm font-medium text-gray-500 mt-4 mb-2">Valid Until</h3>
